                        ...
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              onClick={onClose}
                              type="button"
                              className=" focus :outline-none rounded-md bg-slate-200 text-gray-400 hover:text-gray-500 hover:outline-none hover:ring-2 hover:ring-indigo-500   hover:ring-offset-2 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                            >
                              ...
                              {data.isGroup && (
                                <div>
                                  ...
                                  {data.users.map((user) => (
                                    <dd
                                      key={user.id}
                                      className="mt-5 flex items-center  gap-x-2 text-sm text-gray-900 sm:col-span-2"
                                    >
                                      <Avatar user={user} />
